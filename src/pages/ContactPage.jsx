...
// /* ------------------------------------------------------------------ */
// /*  HERO H1 — mask reveal + shimmer on the payoff line                */
// /* ------------------------------------------------------------------ */
...
//       <div
//         aria-hidden="true"
//         className="pointer-events-none absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-[var(--bg)] via-[color:color-mix(in_srgb,var(--bg)_75%,transparent)] to-transparent"
//       />
...
//       <div className="pointer-events-none absolute left-4 top-4 max-w-[220px] rounded-2xl border border-[var(--border)] bg-[color:color-mix(in_srgb,var(--bg)_90%,transparent)] px-4 py-3 backdrop-blur-md">
...
//       <div className="absolute bottom-4 left-4 right-4 rounded-2xl border border-[var(--border)] bg-[color:color-mix(in_srgb,var(--bg)_92%,transparent)] p-4 backdrop-blur-md">
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <span
          className={`text-[10px] font-semibold uppercase tracking-[.14em] ${
            primary ? 'text-[color:color-mix(in_srgb,var(--bg)_55%,transparent)]' : 'text-[var(--muted)]'
          }`}
        >
          {label}
        </span>
      ...
      <p
        className={`mt-2 max-w-sm text-sm leading-6 ${
          primary ? 'text-[color:color-mix(in_srgb,var(--bg)_68%,transparent)]' : 'text-[var(--muted)]'
        }`}
      >
        {copy}
      </p>
      ...
      {primary && (
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -bottom-16 -right-16 h-44 w-44 rounded-full bg-[var(--accent)] opacity-30 blur-3xl"
        />
      )}
    </Tag>
  );
        ...
        {OFFICES.map((office) => {
          ...
          return (
            ...
            >
              <circle
                r={active ? 17 : 12}
                className="fill-[var(--accent)] opacity-25 motion-safe:animate-pulse"
              />
              <circle
                r={active ? 7 : 5}
                className="fill-[var(--accent)]"
