        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center text-center">
          ...
          <Reveal delay={140}>
            ...
            <h1
              ...
              className="max-w-[14ch] text-balance text-[clamp(2.55rem,7vw,6.6rem)] font-normal leading-[0.93] tracking-[-0.055em]"
            >
              ...
              <span className="bg-gradient-to-r from-[var(--fg)] via-[var(--accent)] to-[var(--fg)] bg-[length:200%_100%] bg-clip-text text-transparent motion-safe:animate-[gradientShift_5s_ease_infinite]">
                Build software that fights for you.
              </span>
            </h1>
          </Reveal>

          <Reveal delay={260} className="mt-6 max-w-2xl">
          ...
          <Reveal delay={360} className="mt-8 flex flex-wrap justify-center gap-3">
            <a
              href="#diagnosis"
          ...
          <Reveal delay={460} className="mt-10 w-full max-w-3xl">
