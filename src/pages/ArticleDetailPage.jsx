...
//   author: '[Author Name]',
//   authorRole: 'Author role / bio',
//   readingTime: '8 min read',
//   date: 'September 23, 2026',
//   intro:
//     '[Add the article introduction here. This should summarize the central argument and give readers a reason to continue.]',
// };
...
//     paragraphs: [
//       '[Add the first article section here. Use this area for the opening argument, evidence, or engineering context.]',
//       '[Add a second paragraph with the supporting detail, example, or observation that moves the argument forward.]',
//     ],
//   },
//   {
//     eyebrow: '02',
...
//     paragraphs: [
//       '[Add the section explaining the gap between adoption and measurable business value.]',
//       '[Add a concrete example, data point, case study, or engineering lesson here.]',
//     ],
//   },
//   {
//     eyebrow: '03',
...
//     paragraphs: [
//       '[Add the practical framework or measurements readers should use instead of adoption alone.]',
//       '[Add the implementation guidance, trade-offs, or decision criteria here.]',
//     ],
//   },
// ];
...
//       <div
//         aria-hidden="true"
//         className="pointer-events-none absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-[var(--bg)] via-[color:var(--bg)/.78] to-transparent"
//       />
...
//             >
//               <Icon name="arrow" className="w-3.5 rotate-180 transition-transform group-hover:-translate-x-1" />
//               Back to Insights
//             </a>
...
//             <h1 className="mt-7 max-w-[14ch] text-balance text-[clamp(2.7rem,7vw,6.2rem)] font-normal leading-[.92] tracking-[-.055em]">
//               {ARTICLE.title}
//             </h1>
...
//                   {ARTICLE.author.startsWith('[') ? 'A' : ARTICLE.author.charAt(0)}
//                 </div>
//                 <div>
//                   <p className="text-sm font-medium">{ARTICLE.author}</p>
//                   <p className="mt-0.5 text-xs text-[var(--muted)]">{ARTICLE.authorRole}</p>
//                 </div>
//               </div>
...
//                   [Add one concise sentence that captures the article&apos;s main takeaway.]
//                 </p>
//               </div>
//             </Reveal>
//           </article>
...
//                 <a
//                   href={ARTICLE.category ? `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : '')}` : '#'}
//                   target="_blank"
//                   rel="noreferrer"
...
//               Turn the question in this article into a conversation about your own product, data, or engineering challenge.
//             </p>
